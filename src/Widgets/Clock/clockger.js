...
class ClockGr extends React.Component {
    constructor(props) {
        super(props)
    ...
    updateClock() {
        var now = Math.round((parseInt(moment().tz("Europe/Paris").format("x")) - parseInt(moment().tz("Europe/Paris").startOf('day').format("x"))) / 1000)
            ...
            <div>
                ...
                <div className="clock"  style={{backgroundColor:this.props.status?"#f8f8f852":"#363434"}}>
                    ...
                    <div className="clock-container">
                        <ClockHand name="hourgr" rotate={this.state.h} />
                        <ClockHand name="mingr" rotate={this.state.m} />
                        <ClockHand name="secondgr" rotate={this.state.s} />
                    </div>
